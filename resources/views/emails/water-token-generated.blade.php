...
@php
    ...
    $meterToken = $stsTransaction->tokens->first();
    $token = $meterToken?->token ?? $stsTransaction->token;
    $volume = $meterToken?->volume_m3 ?? $stsTransaction->volume_m3;
    $meterNumber = $stsTransaction->meter ?->meter_number;
            ...
            <tr>
                <td align="center">
                    <table width="100%" cellpadding="0" cellspacing="0" style=" max-width:600px; background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #e2e8f0; ">
                        <tr>
                            <td style=" padding:24px; background:#0369a1; color:#ffffff; " >
                                <h2 style="margin:0;">
                                    Your Water Token
                                </h2>
                            </td>
                        ...
                        <tr>
                            <td style="padding:30px;">
                                ...
                                <div
                                    style=" margin:25px 0; padding:25px; border-radius:12px; background:#eff6ff; text-align:center; border:1px solid #bfdbfe; ">
                                    <div style=" font-size:13px; color:#64748b; margin-bottom:8px; ">
                                        TOKEN
                                    </div>
                                    <div style=" font-size:26px; font-weight:bold; letter-spacing:3px; color:#0f172a; " >
                                        {{ $token }}
                                    </div>
                                </div>

                                <table  width="100%" cellpadding="9" cellspacing="0" style=" background:#f8fafc; border-radius:8px; ">
                                    <tr>
                                        <td>
                                            Payment Reference
                                        </td>
                                ...
                                <div style=" margin-top:25px; padding:15px;  background:#fefce8; border:1px solid #fde68a; border-radius:8px; ">
                                    ...
                                    Enter this token into the prepaid water meter associated with meter {{ $meterNumber ?? '-' }}
                                </div>
